...
**Version 1.8.0** · Mongoose Traveller 2e Space Combat Simulator
...
| Category | Symbols |
| -------- | ------- |
| **Tokens** | Ship silhouette (swept-wing polygon, rotates to face velocity); HP arc (green/yellow/red); missile salvo (yellow — count + thrust shown) |
