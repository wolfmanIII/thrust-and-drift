...
- 960 test (+18 rispetto a v1.22.3 dopo coverage fill: critIndex, spendMissileAmmo ×3, applyInitiativeBonus FIX-06 ×4 + initiativeOrder re-sort; subscribeEffects ×5, hoveredShip/Missile/toggleAudio ×7, io export DOM ×6).
