      ...
      <main className="help-content flex-1 overflow-y-auto px-8 py-6 space-y-10">
        ...
        <Section id="attack" title="Attack Phase">
          ...
          <Sub title="LAUNCHING MISSILES">
            ...
            <p><span className="text-slate-200">Missile Rack</span> (CRB p.162) — adjust salvo count using the stepper. Salvo size is capped at the number of Missile Rack components mounted in the selected turret — a lone rack sharing a turret with other weapon types launches at most 1 missile per round, a homogeneous triple-rack turret up to 3 (Traveller Companion p.172 / HG p.31). Magazine: 12 per rack. Damage: 4D6 per missile.</p>
