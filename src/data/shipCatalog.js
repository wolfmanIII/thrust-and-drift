...
export const SHIP_CATALOG = [
  ...
  makeEntry({
    ...
    sensors:  'Basic',
    turrets:  [{ slot: 1, weapons: ['Pulse Laser'] }],
    crew:     { pilot: 1, captain: 0, engineer: 0, gunner: 1, sensors: 0 },
    fuel:     0,
    cargo:    2,
  }),
  ...
  makeEntry({
    ...
    sensors:  'Basic',
    turrets:  [],
    crew:     { pilot: 1, captain: 0, engineer: 1, gunner: 0, sensors: 0 },
    fuel:     45,
    cargo:    0,
  }),
  ...
  makeEntry({
    ...
    crew:     { pilot: 1, captain: 0, engineer: 1, gunner: 2, sensors: 0 },
    fuel:     40,
    cargo:    70,
    passengers: 9,
  }),
  ...
  makeEntry({
    ...
    sensors:  'Civilian',
    turrets:  [],
    crew:     { pilot: 1, captain: 0, engineer: 2, gunner: 0, sensors: 0 },
    fuel:     116,
    cargo:    3,
  }),
  ...
  makeEntry({
    ...
    crew:     { pilot: 4, captain: 1, engineer: 1, gunner: 4, sensors: 1 },
    fuel:     6,
    cargo:    15,
  }),
  ...
  makeEntry({
    ...
    sensors:  'Improved',
    turrets:  [],
    crew:     { pilot: 1, captain: 0, engineer: 0, gunner: 0, sensors: 1 },
    fuel:     82,
    cargo:    22,
  }),
  ...
  makeEntry({
    ...
    crew:     { pilot: 1, captain: 0, engineer: 1, gunner: 3, sensors: 0 },
    fuel:     70,
    cargo:    46,
  }),
  ...
  makeEntry({
    ...
    crew:     { pilot: 3, captain: 1, engineer: 4, gunner: 8, sensors: 0 },
    fuel:     130,
    cargo:    12,
  }),
  ...
  makeEntry({
    ...
    crew:     { pilot: 2, captain: 1, engineer: 2, gunner: 2, sensors: 0 },
    fuel:     230,
    cargo:    5,
  }),
  ...
  makeEntry({
    ...
    crew:     { pilot: 1, captain: 0, engineer: 2, gunner: 4, sensors: 0 },
    fuel:     122,
    cargo:    47,
  }),
  ...
  makeEntry({
    ...
    sensors:  'Improved',
    turrets:  [],
    crew:     { pilot: 1, captain: 0, engineer: 2, gunner: 0, sensors: 1 },
    fuel:     124,
    cargo:    26,
  }),
  ...
  makeEntry({
    ...
    crew:     { pilot: 3, captain: 1, engineer: 2, gunner: 6, sensors: 3 },
    fuel:     12,
    cargo:    18,
  }),
  ...
  makeEntry({
    ...
    sensors:  'Civilian',
    turrets:  [],
    crew:     { pilot: 2, captain: 1, engineer: 3, gunner: 0, sensors: 0 },
    fuel:     183,
    cargo:    60,
    passengers: 44,
  }),
